      ...
      <ul className={styles.container}>
        <ul>
          ...
          <ul>
            ...
            <li className={styles.detail}>차원에서 부과됩니다.</li>
            <li className={styles.detail}>특히 전세/관광버스의 특성상 운임요금 및 성수기와 비수기의 수요 공급에 따라 다르게 책정되오며 임차 운임자체가 비싸고</li>
            <li className={styles.detail}>미리 예약된 버스 및 운행예약이 취소가 되면 다른 고객과의 계약이 불가능하게 되므로 운휴대체비용이 부가되는 것입니다.</li>
            <br/>
            <li className={styles.detail}>단, 운수 회사의 귀책으로 운행을 못하게 되었을시 운수회사는 예약금 100%를 고객에게 지급해야 합니다.</li>
            <br/>
            <li className={styles.detail}>이외에 민법의 규정에도 계약은 상호 신의 성실의 원칙에 따라 지켜져야 한다고 규정되어 있으며, 규정되지 않은 사항에</li>
            <li className={styles.detail}>대해서는 상호간의 합의에 따라 해지 및 환불을 해드리고 있습니다.</li>
          </ul>
        </ul>
        ...
        <ul>
          ...
          <ul>
            ...
            <ul className={styles.detailContainer}>
              ...
              <li className={styles.detail}>- 운행예정일 (2일전까지) 취소시 예약금액 20% 환불</li>
              <li className={styles.detail}>- 운행예정일 (당일) 취소시 예약금액 전액 환불불가/예약금이 없을시 위약금 20%</li>
            </ul>
          </ul>
          ...
          <ul>
            ...
            <ul className={styles.detailContainer}>
              ...
              <li className={styles.detail}>- 운행예정일 (당일) 취소시 전액 환불불가/예약금이 없을 시 위약금 10%</li>
            </ul>
          </ul>
        </ul>
      </ul>
        ...
        <ul>
          ...
          <ul>
            ...
            <ul className={styles.detailContainer}>
              ...
              <li className={styles.detail}>계좌번호 : 국민은행 810137-04-006627</li>
            </ul>
          </ul>
        </ul>
