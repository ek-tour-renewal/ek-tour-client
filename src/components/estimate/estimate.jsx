      ...
      <form className={styles.data} onSubmit={onSubmit}>
        <section className={styles.estimate_1}>
          <li className={styles.travel}>
            <p>여행구분</p>
            <select className={styles.travelSelect}>
          ...
          <li className={styles.departPlace}>
            ...
            <input className={styles.placeInput} type='text' />
          </li>
          ...
          <li className={styles.memo}>
            ...
            <textarea className={styles.memoTextarea} cols='30' rows='10'></textarea>
          </li>
        ...
        <section className={styles.estimate_2}>
          ...
          <li className={styles.memberCount}>
            ...
            <input className={styles.memberCountInput} type='text' />
            명
          </li>
