...
const Estimate = (props) => {
  return (
    <section className={styles.estimate}>
          <div>
            <button className={styles.estimateButton}>실시간 견적요청</button>
            <ul className={styles.data}>
              <li className={styles.travel}>
                <p>여행구분</p>
                <select className={styles.select} name="travel">
              ...
              <li className={styles.phone}>
                <p>핸드폰</p>
                <select className={styles.select} name="phone">
              ...
              <li className={styles.departurePlace}>
                <p>출발지</p>
                <select className={styles.select} name="departure-place">
              ...
              <li className={styles.destination}>
                <p>도착지</p>
                <select className={styles.select} name="destination">
                  <option value="seoul">서울</option>
                  <option value="gyeonggi">경기</option>
                  <option value="gangwon">강원</option>
                  <option value="gyeongbug">경북</option>
              ...
              <li className={styles.vehicleNumber}>
                <p>차량댓수</p>
                <select className={styles.select} name="vehicleNumber">
