...
const ServiceCenter = ({ companyData }) => {
  useEffect(() => {
      ...
      <section className={styles.serviceCenter}>
        ...
        <ul className={styles.useInfo}>
          <li className={styles.useStep}>
            ...
            <p className={styles.mainUseStep}>
              견적요청 <br /> 전화상담
            </p>
          </li>
        ...
        <ul className={styles.useInfoDetailContainer}>
          <li className={styles.useInfoDetail}>
            견적요청시 자동으로 문자메시지가 발송됩니다.
          </li>
          <li className={styles.useInfoDetail}>
            모든 견적은 부가세 별도이며 카드, 현금영수증, 세금계산서 발급시 10%
            추가됩니다.
          </li>
        </ul>
        {/* 취소 및 환불규정 */}
        ...
        <ul className={styles.container}>
          <li>
            ...
            <li className={styles.policyDetail}>
              ...
              <li>
                취소 및 환불에 대한 규정은 예약부도에 대한 당사의 손해를
                방지하고 장기적으로 고객님들에게 보다 나은 서비스를 제공하는
              </li>
              <li>차원에서 부과됩니다.</li>
              <li>
                특히 전세/관광버스의 특성상 운임요금 및 성수기와 비수기의 수요
                공급에 따라 다르게 책정되오며 임차 운임자체가 비싸고
              </li>
              <li>
                미리 예약된 버스 및 운행예약이 취소가 되면 다른 고객과의 계약이
                불가능하게 되므로 운휴대체비용이 부가되는 것입니다.
              </li>
              <br />
              <li>
                단, 운수 회사의 귀책으로 운행을 못하게 되었을시 운수회사는
                예약금 100%를 고객에게 지급해야 합니다.
              </li>
              <br />
              <li>
                이외에 민법의 규정에도 계약은 상호 신의 성실의 원칙에 따라
                지켜져야 한다고 규정되어 있으며, 규정되지 않은 사항에
              </li>
              <li>
          ...
          <li>
            ...
            <li className={styles.policyDetail}>
              <li className={styles.dateDetail}>
            ...
            <li className={styles.policyDetail}>
              ...
              <div className={styles.dateDetailContainer}>
                ...
                <li>
                  - 운행예정일 (당일) 취소시 전액 환불불가/예약금이 없을 시
                  위약금 10%
                </li>
              </div>
            </li>
        ...
        <ul className={styles.container}>
          <li>
            <li className={styles.list}>
              <h3>
                (주)이케이하나관광은 24시간 상담이 가능하며 카톡으로도 실시간
                상담이 가능합니다.
              </h3>
            </li>
            <li className={styles.serviceDetail}>
              <li className={styles.serviceNotice}>
                <h4>💻 고객센터 안내</h4>
              </li>
              <div className={styles.serviceDetailContainer}>
                <li>
                  전화번호 : {companyData.tel} 팩스번호 : {companyData.fax}
                </li>
                <li>이메일 상담 : {companyData.email}</li>
                <li>카톡아이디 : {companyData.kakaoTalkId}</li>
              </div>
            </li>
            <li className={styles.accountDetail}>
              <li className={styles.accountNotice}>
                <h4>💸 계좌번호 안내</h4>
              </li>
              <div className={styles.accountDetailContainer}>
                <li>예금주 : {companyData.accountHolder}</li>
                <li>
                  계좌번호 : {companyData.accountBank} {companyData.accountNum}
                </li>
              </div>
            </li>
          </li>
          <li className={styles.list}>
            <h3>
              통장사본과 사업자등록증 사본은 이곳에서 다운로드 가능합니다.
            </h3>
          </li>
        </ul>
      </section>
