                ...
                <TableRow>
                  ...
                  <TableCell sx={{ width: '70%' }}>
                    <Stack direction='row' spacing={1}>
                      ...
                      <TextField autoComplete='off' onChange={handleValueChange} name='middleNum' size='small' inputProps={{ maxLength: 4, type: 'tel' }} value={myInfo.middleNum} />
                      <Typography variant='h5'>-</Typography>
                      <TextField autoComplete='off' onChange={handleValueChange} name='lastNum' size='small' inputProps={{ maxLength: 4, type: 'tel' }} value={myInfo.lastNum} />
                    </Stack>
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>
                    <TextField autoComplete='off' onChange={handleValueChange} name='password' size='small' inputProps={{ maxLength: 4, type: 'password' }} value={myInfo.password} sx={{ width: '100%' }} />
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
