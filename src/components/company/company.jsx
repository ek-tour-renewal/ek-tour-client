...
const Company = ({ menu, changeMenu, menus }) => {
  // side menu
  const menuList = [
  ...
  return (
    <main className={styles.company}>
      <SubHeader menu={menu} />
      <section>
        <div className={styles.shortContentContainer}><p className={styles.shortContent}>고객의 행복을 함께 만들어갑니다.</p></div>
        <div className={styles.detail}>
          ...
          <ul className={styles.contents}>
            ...
            <li className={styles.contentDetail}>
              (주)이케이투어는 언제나 고객과 임직원들에게 믿음과 신뢰를 주는 회사로 소문이 나기를 <br />
